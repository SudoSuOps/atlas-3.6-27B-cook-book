...
#   [ ] /data1/atlas-qwen-27b-v4/train.jsonl exists (Block-1-v2 · sha 4d90e676...)
#   [ ] /data1/atlas-qwen-27b-v4/eval.jsonl  exists (Block-1-v2 · sha 7f025a26...)
...
LOG_FILE="/data1/atlas-qwen-27b-v4/cook.log"

mkdir -p /data1/atlas-qwen-27b-v4
